...
import allen.emoj.adapter.HorizontalRecyclerviewAdapter;
import allen.emoj.adapter.NoHorizontalScrollerVPAdapter;
import allen.emoj.model.ImageModel;
import allen.emoj.utils.EmotionUtils;
import allen.emoj.utils.GlobalOnItemClickManagerUtils;
import allen.emoj.utils.SharedPreferencedUtils;
import allen.emoj.widget.EmotionKeyboard;
import allen.emoj.widget.NoHorizontalScrollerViewPager;
...
public class EmotionMainFragment extends BaseFragment {
    ...
    private AppCompatEditText bar_edit_text;
    private AppCompatImageView bar_image_add_btn;
    private AppCompatButton bar_btn_send;
    private LinearLayoutCompat rl_editbar_bg;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mEmotionKeyboard = EmotionKeyboard.with(getActivity())
                ...
                .bindToEditText(!isBindToBarEditText ? ((AppCompatEditText) contentView) : ((AppCompatEditText) rootView.findViewById(R.id.bar_edit_text)))//判断绑定那种EditView
        ...
        if(isBindToBarEditText){
            ...
            // false,则表示绑定contentView,此时外部提供的contentView必定也是EditText
            globalOnItemClickManager.attachToEditText((AppCompatEditText) contentView);
            mEmotionKeyboard.bindToEditText((AppCompatEditText)contentView);
        }
        return rootView;
    }
    ...
    protected void initView(View rootView){
        ...
        bar_image_add_btn= rootView.findViewById(R.id.bar_image_add_btn);
